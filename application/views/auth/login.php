			...
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-grid--tablet-and-mobile m-grid--hor-tablet-and-mobile m-login m-login--1 m-login--signin" id="m_login">
						...
						<div class="m-stack__item m-stack__item--fluid">
							<div class="m-login__wrapper">
								<div class="m-login__logo">
									<a href="#">
										<img src="<?= base_url('assets/') ?>demo/default/media/img/logo/BRKSyariah.png">
									</a>
								</div>
								<div class="m-login__signin">
									...
									<form class="user" method="post" action="<?= base_url('auth'); ?>">
										...
										<div class="m-login__form-action">
											...
											<button type="submit" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--air"><a href="<?= site_url('Auth/registrasi') ?>" class="text-white">Daftar</a></button>
										</div>
									</form>
									<!-- <form class="user" method="post" action="<?= base_url('auth'); ?>">
										<div class="form-group m-form__group">
				...
				<div class="m-grid__item m-grid__item--fluid m-grid m-grid--center m-grid--hor m-grid__item--order-tablet-and-mobile-1	m-login__content m-grid-item--center" style="background-image: url(<?= base_url('assets/') ?>app/media/img//bg/bg-4.jpg)">
					<div class="m-grid__item">
						<h3 class="m-login__welcome">BRK SYARIAH</h3>
						<p class="m-login__msg">
							Lorem ipsum, dolor sit amet consectetur adipisicing elit. Excepturi consectetur possimus 
							<br> similique consequuntur laborum at facilis ipsam recusandae asperiores! Sed.
						</p>
					</div>
				</div>
			</div>
